    ...
    function hideBox(){
        ...
        if(ARInitRunning){
            ...
            if(markerRoot1.visible == false && firstTimeSeen == true)
            {
                seen = 1;
            }
        }
    ...
    function markerlost(){
        if(markerRoot1.visible && seen == 0 && firstTimeSeen == false )
        {
        ...
        if(markerRoot1.visible && seen == 0 && firstTimeSeen == true )
        {
